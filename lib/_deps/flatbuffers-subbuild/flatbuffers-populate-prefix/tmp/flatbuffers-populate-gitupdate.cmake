...
execute_process(
  COMMAND "/usr/bin/git" show-ref "v2.0.6"
  WORKING_DIRECTORY "/workspace/tensorflow/tensorflow/lite/build/flatbuffers"
...
if("${show_ref_output}" MATCHES "refs/remotes/v2.0.6")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "v2.0.6")
    ...
    if("REBASE" STREQUAL "CHECKOUT")
      ...
      if(error_code)
        ...
        if(NOT "REBASE" STREQUAL "REBASE_CHECKOUT")
          ...
          message(FATAL_ERROR "\nFailed to rebase in: '/workspace/tensorflow/tensorflow/lite/build/flatbuffers'."
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/workspace/tensorflow/tensorflow/lite/build/flatbuffers'."
                              "\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()

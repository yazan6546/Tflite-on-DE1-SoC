...
if("${show_ref_output}" MATCHES "refs/remotes/0d859a811870d10f53a594927d0d0b97573ad06d")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "0d859a811870d10f53a594927d0d0b97573ad06d")
  set(git_remote "${CMAKE_MATCH_1}")
  set(git_tag "${CMAKE_MATCH_2}")
else()
  set(git_remote "origin")
  set(git_tag "0d859a811870d10f53a594927d0d0b97573ad06d")
endif()
    ...
    if("REBASE" STREQUAL "CHECKOUT")
      ...
      if(error_code)
        ...
        if(NOT "REBASE" STREQUAL "REBASE_CHECKOUT")
          ...
          message(FATAL_ERROR "\nFailed to rebase in: '/workspace/tensorflow/tensorflow/lite/build/farmhash'."
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/workspace/tensorflow/tensorflow/lite/build/farmhash'."
                              "\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()

...
execute_process(
  COMMAND "/usr/bin/git" show-ref "3dc310302210c1891ffcfb12ae67b11a3ad3a150"
  WORKING_DIRECTORY "/workspace/tensorflow/tensorflow/lite/build/cpuinfo"
...
if("${show_ref_output}" MATCHES "refs/remotes/3dc310302210c1891ffcfb12ae67b11a3ad3a150")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "3dc310302210c1891ffcfb12ae67b11a3ad3a150")
  set(git_remote "${CMAKE_MATCH_1}")
  set(git_tag "${CMAKE_MATCH_2}")
else()
  set(git_remote "origin")
  set(git_tag "3dc310302210c1891ffcfb12ae67b11a3ad3a150")
endif()
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'https://github.com/pytorch/cpuinfo'")
  endif()
    ...
    if("REBASE" STREQUAL "CHECKOUT")
      ...
      if(error_code)
        ...
        if(NOT "REBASE" STREQUAL "REBASE_CHECKOUT")
          ...
          message(FATAL_ERROR "\nFailed to rebase in: '/workspace/tensorflow/tensorflow/lite/build/cpuinfo'."
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/workspace/tensorflow/tensorflow/lite/build/cpuinfo'."
                              "\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()

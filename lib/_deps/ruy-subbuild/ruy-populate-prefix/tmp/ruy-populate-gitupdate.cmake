...
if("${show_ref_output}" MATCHES "refs/remotes/3286a34cc8de6149ac6844107dfdffac91531e72")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "3286a34cc8de6149ac6844107dfdffac91531e72")
  set(git_remote "${CMAKE_MATCH_1}")
  set(git_tag "${CMAKE_MATCH_2}")
else()
  set(git_remote "origin")
  set(git_tag "3286a34cc8de6149ac6844107dfdffac91531e72")
endif()
    ...
    if("REBASE" STREQUAL "CHECKOUT")
      ...
      if(error_code)
        ...
        if(NOT "REBASE" STREQUAL "REBASE_CHECKOUT")
          ...
          message(FATAL_ERROR "\nFailed to rebase in: '/workspace/tensorflow/tensorflow/lite/build/ruy'."
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/workspace/tensorflow/tensorflow/lite/build/ruy'."
                              "\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
